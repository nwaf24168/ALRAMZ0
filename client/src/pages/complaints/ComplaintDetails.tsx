          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#20232b] rounded-xl p-6 space-y-6 border border-gray-800/30">
              ...
              <div className="p-4 bg-gray-900/50 border border-gray-600/30 rounded-lg">
                <p className="text-gray-200 leading-relaxed text-sm font-medium">{complaint.details}</p>
              </div>
            </div>
            ...
            <div className="bg-[#20232b] rounded-xl p-6 space-y-6 border border-gray-800/30">
              ...
              <div className="p-4 bg-gray-900/50 border border-gray-600/30 rounded-lg">
                <p className="text-gray-200 leading-relaxed text-sm font-medium">{complaint.action}</p>
              </div>
            </div>
          </div>
        </div>
